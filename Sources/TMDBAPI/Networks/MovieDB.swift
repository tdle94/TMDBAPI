...
public struct MovieDB {
    ...
    public func detail(id: Int, language: String = "") async throws -> Result<MovieDetail, TMDBMessage> {
    ...
    public func credits(id: Int, language: String = "") async throws -> Result<Credit, TMDBMessage> {
    ...
    public func images(id: Int, language: String = "") async throws -> Result<TMDBImage, TMDBMessage> {
    ...
    public func recommendations(id: Int, language: String = "", page: Int = 1) async throws -> Result<MovieType, TMDBMessage> {
    ...
    public func similars(id: Int, language: String = "", page: Int = 1) async throws -> Result<MovieType, TMDBMessage> {
        let urlRequest = Movie.similars(id: id, language: language, page: page).urlRequest
        return try await network.performURLRequest(urlRequest, type: MovieType.self)
    }
    
    public func videos(id: Int, language: String = "") async throws -> Result<Video, TMDBMessage> {
    ...
    public func nowPlaying(language: String = "", region: String = "", page: Int = 1) async throws -> Result<MovieType, TMDBMessage> {
        let urlRequest = Movie.nowPlaying(language: language, page: page, region: region).urlRequest
        return try await network.performURLRequest(urlRequest, type: MovieType.self)
    }
    
    public func popular(language: String = "", region: String = "", page: Int = 1) async throws -> Result<MovieType, TMDBMessage> {
        let urlRequest = Movie.popular(language: language, page: page, region: region).urlRequest
        return try await network.performURLRequest(urlRequest, type: MovieType.self)
    }
    
    public func topRated(language: String = "", region: String = "", page: Int = 1) async throws -> Result<MovieType, TMDBMessage> {
        let urlRequest = Movie.topRated(language: language, page: page, region: region).urlRequest
        return try await network.performURLRequest(urlRequest, type: MovieType.self)
    }
    
    public func upcoming(language: String = "", region: String = "", page: Int = 1) async throws -> Result<MovieType, TMDBMessage> {
        let urlRequest = Movie.upcoming(language: language, page: page, region: region).urlRequest
        return try await network.performURLRequest(urlRequest, type: MovieType.self)
    }
    
    public func latest(language: String = "") async throws -> Result<MovieDetail, TMDBMessage> {
